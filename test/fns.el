...
(assert-matches "1 failure over 1 assertion" (test-simple-summary-line test-info)
		"handling singular correctly")
(incf (test-info-assert-count test-info))
(assert-matches "1 failure over 2 assertions" (test-simple-summary-line test-info)
